...
print(f'{nettó_ár*(1+NÉMET/100):10.2f} picula Németországban.')
print(f'{nettó_ár*(1+BRIT/100):10.2f} picula Németországban.')
print(f'{nettó_ár*(1+CSEH/100):10.2f} picula Németországban.')
print(f'{nettó_ár*(1+LENGYEL/100):10.2f} picula Németországban.')
